...
import io.wazn.androidminer.api.PaymentItem;
import io.wazn.androidminer.api.ProviderData;
import io.wazn.androidminer.widgets.PaymentInfoAdapter;
...
public class PaymentsActivity extends BaseActivity implements PaymentInfoAdapter.OnShowPaymentListener {
    ...
    public void onShowPayment(final PaymentItem paymentItem) {
        String paymentURL = "https://explorer.wazn.io/tx?tx_info=" + paymentItem.mHash;
