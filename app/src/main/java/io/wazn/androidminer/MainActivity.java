        ...
        implements BottomNavigationView.OnNavigationItemSelectedListener
{
    ...
    private void saveBitmap(Bitmap bitmap) {
        ...
        imagePath = new File(Environment.getExternalStorageDirectory() + "/wazn_scrnshot.png"); ////File imagePath
    ...
    private void shareIt() {
        ...
        String shareBody = "Take a look at my Wazn Droid stats!";
        sharingIntent.putExtra(android.content.Intent.EXTRA_SUBJECT, "My Wazn Droid Stats");
