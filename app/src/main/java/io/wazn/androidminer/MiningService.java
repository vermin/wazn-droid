...
public class MiningService extends Service {
    ...
    private void copyMinerFiles() {
        ...
        String assetExtension = Config.miner_waznrig;
    ...
    public MiningConfig newConfig(String address, String password, int cores, int threads, int intensity) {
        ...
        config.assetExtension = Config.miner_waznrig;
    ...
    public void startMiningProcess(MiningConfig config) {
        ...
        try {
            ...
            String[] args = {"./" + Config.miner_waznrig};
            ...
            outputHandler = new MiningService.OutputReaderThread(process.getInputStream(), Config.miner_waznrig);
            outputHandler.start();
