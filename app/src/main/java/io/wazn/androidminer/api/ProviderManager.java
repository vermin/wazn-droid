...
import io.wazn.androidminer.SettingsFragment;
import io.wazn.androidminer.Tools;
...
public final class ProviderManager {
    ...
    static private final String DEFAULT_POOLS_REPOSITORY = "https://raw.githubusercontent.com/vermin/wazn-droid/v2.0.0/app.json";
    ...
    static private final String IPNS_NAME = "pool-list.wazn.io";
    ...
    static private final String DEFAULT_POOL = "{\n" +
            "\"pools\": [\n" +
            "{\n" +
            "\"key\": \"Wazn Official Pool\",\n" +
            "\"pool\": \"dig.wazn.io\",\n" +
            "\"port\": \"3333\",\n" +
            "\"ports\": [\"3333\", \"4444\", \"5555\"],\n" +
            "\"type\": 2,\n" +
            "\"url\": \"https://pool.wazn.io\",\n" +
            "\"ip\": \"157.90.229.215\"\n" +
            "} ]\n" +
            "}";
